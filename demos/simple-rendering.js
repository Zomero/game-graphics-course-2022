...
import { positions, normals, indices } from "../blender/ajkfldc.js"
...
let bgColor = vec4.fromValues(0.3, 0.3, 0.7, 0.0);
let fgColor = vec4.fromValues(0.5, 0.1, 0.5, 0.0);
...
function draw() {
    ...
    mat4.fromXRotation(rotateXMatrix, time * 1);
